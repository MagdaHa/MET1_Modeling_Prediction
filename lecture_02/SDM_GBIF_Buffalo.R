...
#### ####
###############################################
#----------https://bitbucket.org/rsbiodiv/species_distribution_model/src/master/gam_random_forest_maxent_example.R
...
setwd("C:\\02_Studium\\02_Master\\02_Semester_2\\MET1_Spatial_modelling_and_prediction\\MET1_Modeling_Prediction\\lecture_02")
